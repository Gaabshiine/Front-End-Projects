...
var validateInputs = () => {
  ...
  /* check all the inputs are empty*/
  ...
  /* Total of any amount */
  var total_ch_ch = ch_ch * muchValue;
  var total_ch_pi = ch_pi * muchValue;
  var total_fish_pi = fi_pi * muchValue;
  var total_meat_pi = mi_pi * muchValue;
  var total_tur_bur = tur_bur * muchValue;
  var total_beef_bur = beef_bur * muchValue;
  var total_vg_bur = vg_bur * muchValue;
  var total_mango = mango_cho * muchValue;
  var total_lemon = lemon * muchValue;
  var total_recipe = recipe * muchValue;


  // check if the order is chicken
  if (orderValue == 'chicken and chips') {
    if (moneyValue == total_ch_ch) {
      setSuccess(money);
    } else {
  ...
  // check if the order is chicken and pizza
  if (orderValue == 'chicken pizza') {
    if (moneyValue == total_ch_pi) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is fish pizza
  if (orderValue == 'fish pizza') {
    if (moneyValue == total_fish_pi) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is meat pizza
  if (orderValue == 'meat pizza') {
    if (moneyValue == total_meat_pi) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is turkey burgers
  if (orderValue == 'turkey burgers') {
    if (moneyValue == total_tur_bur) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is beef burgers
  if (orderValue == 'beef burgers') {
    if (moneyValue == total_beef_bur) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is veggie burgers
  if (orderValue == 'veggie burgers') {
    if (moneyValue == total_vg_bur) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is mango juice
  if (orderValue == 'mango juice') {
    if (moneyValue == total_mango) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is lemon juice
  if (orderValue == 'lemon juice') {
    if (moneyValue == total_lemon) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
  ...
  // check if the order is recipe red juice
  if (orderValue == 'recipe red juice') {
    if (moneyValue == total_recipe) {
      setSuccess(money);
    } else {
      setError(money, 'the money is greaterthan or lessthan that you are required');
      return false;
